...
class DatabaseTypeIncome {
  static final DatabaseTypeIncome _instance = DatabaseTypeIncome._internal();
  factory DatabaseTypeIncome() => _instance;
  DatabaseTypeIncome._internal();

  static const String _dbName = 'typeIncome.db';
  static const String _storeName = 'type_income_store';
